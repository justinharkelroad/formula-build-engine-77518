...
drop policy if exists "Admins can view purchase email deliveries"
...
drop policy if exists "Admins can view purchase email delivery events"
...
revoke insert, update, delete, truncate, references, trigger
  on public.purchase_email_deliveries from authenticated;
revoke insert, update, delete, truncate, references, trigger
  on public.purchase_email_delivery_events from authenticated;
...
comment on table public.purchase_email_deliveries is
  'Durable transactional email outbox for Stripe ticket and partner purchases.';
comment on table public.purchase_email_delivery_events is
  'Verified Resend delivery webhook events used for audit and status updates.';
