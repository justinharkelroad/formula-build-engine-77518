-- Formula 2026 registry transition to the Training the Transfer registry
-- (3b3e39f5…). Same owner-only, guarded, idempotent shape as
-- 20260911210000: the accepted sources are the workbook-v7 and print-ready
-- generations; reruns return 0 once the row already holds the new hash.
--
-- Rollout note: Firebase functions, firestore.rules, the Flutter app, and the
-- Flow site accept bcbb5db2…, a6963663… and 3b3e39f5…, so this
...
declare
  accepted_source_registry_hashes constant text[] := array[
    ...
    'a6963663935e408c8692cf8857fdf040716150bb79d8d8734999100c8b2208de'
  ];
  new_registry_hash constant text := '3b3e39f570fc4be72145738de7577ce8e6223bc03840b58cb6ded95e17fd4ea7';
  event_record record;
...
comment on function formula_private.transition_formula_2026_registry() is
  'Owner-only guarded and idempotent Formula 2026 registry transition with linked-identity reprojection (Training the Transfer, 3b3e39f5).';
