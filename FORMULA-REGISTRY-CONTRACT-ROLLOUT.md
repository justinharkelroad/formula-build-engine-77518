...
- Previous hash: `e848e7a952badb1e1c072fc81050cafafca597ea45189f91cf30645fcfc5e404`
- Current hash: `e6d64ba4b9b13f1d577d7ace6a8e406e67cdccc6cf03af8290caee21c1b49faa`
- Registry version: `1`
...
3. Apply `20260905171632_transition_formula_2026_registry_contract.sql` to the correct Supabase project. Its owner-only transition accepts only the previous hash at registry version 1, returns without writes if already current, and fails closed for any other state.
...
select
  count(*) filter (where payload ->> 'registryHash' = 'e6d64ba4b9b13f1d577d7ace6a8e406e67cdccc6cf03af8290caee21c1b49faa') as current_hash_rows,
  count(*) filter (where payload ->> 'registryHash' <> 'e6d64ba4b9b13f1d577d7ace6a8e406e67cdccc6cf03af8290caee21c1b49faa') as other_hash_rows
from formula_private.projection_outbox
