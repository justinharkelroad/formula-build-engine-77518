...
const FAQ = () => {
  ...
  const description = "Frequently asked questions about Formula Forum 2026: refund policy, hotel room block at JW Marriott ($299/night), group discounts, dress code, and what's included.";
