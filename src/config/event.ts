...
export const CONFIG = {
  ...
  LOGO_SPONSORS: [
    ...
    { name: "Ricochet360", tier: "Sponsor", logoUrl: "/assets/sponsors/ricochet360.png", linkUrl: "https://ricochet360.com" },
    {
      ...
      podcast: {
        company: "Arbeit",
        guestName: "Matt Robinson",
        headshotUrl: "/assets/partners/matt-robinson-arbeit.png?v=20260902",
        headshotWidth: 200,
        headshotHeight: 200,
        vimeoId: "1223367402",
        contactLabel: "Email Matt",
        contactUrl: "mailto:matt@arbeitsoftware.com",
        contactDisplay: "matt@arbeitsoftware.com · arbeitsoftware.com",
