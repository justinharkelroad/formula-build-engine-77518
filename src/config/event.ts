export const CONFIG = {
  ...
  LOGO_SPONSORS: [
    ...
    },
    {
      name: "Post Pros",
      tier: "Silver",
      logoUrl: "/assets/sponsors/post-pros.svg",
      linkUrl: "https://postpros.com/insurance",
      podcast: {
        company: "Post Pros",
        guestName: "Ryan Francis",
        headshotUrl: "/assets/partners/ryan-francis-post-pros-centered.png?v=20260915",
        headshotWidth: 1254,
        headshotHeight: 1254,
        vimeoId: "1227067766",
        contactLabel: "Visit Post Pros",
        contactUrl: "https://postpros.com/insurance",
        contactDisplay: "info@postpros.com · 281-801-7007 · postpros.com/insurance",
        contactDescription: "Ryan shared how Post Pros helps insurance agencies use targeted direct mail and measure the premium and return generated by each campaign.",
      },
    },
    {
    ...
    { name: "DMS", tier: "Bronze", logoUrl: "/assets/sponsors/dms.png", linkUrl: "https://digitalmediasolutions.com" },
    {
      ...
      podcast: {
        company: "LeadMiner",
        guestName: "Scott",
        headshotUrl: "/assets/partners/scott-leadminer.jpg?v=scott-20260909",
        headshotWidth: 5000,
        headshotHeight: 3333,
        vimeoId: "1223169978",
    ...
    // Added 2026-09-18 per Justin. Logo keyed off the white-background lockup he supplied.
    { name: "Authority War", tier: "Bronze", logoUrl: "/assets/sponsors/authority-war.png", linkUrl: "https://authoritywar.com/" }
  ]
} as const;
