  ...
  return (
    <section className="py-8 bg-muted/30 border-t border-b">
      <div className="container mx-auto px-4">
            ...
            {CONFIG.LOGO_PARTNERS.map((partner, index) => (
              <div key={index} className="flex items-center justify-center">
                ...
                >
                   <img 
                     src={partner.logoUrl} 
                     alt={`${partner.name} — ${partner.tier} sponsor of Formula Forum 2026`}
          ...
          <div className="flex justify-center items-center gap-8 py-6">
            <div className="flex items-center justify-center">
              <img 
                ...
                alt="DART Direct Mail — Gold sponsor of Formula Forum 2026"
            ...
            <div className="flex items-center justify-center">
              <img 
                ...
                alt="American Integrity Insurance Group — Gold sponsor of Formula Forum 2026"
                className="h-12 w-auto object-contain"
                loading="lazy"
                width="100"
                height="48"
            ...
            <div className="flex items-center justify-center">
              <img 
                ...
                alt="Performology — Gold sponsor of Formula Forum 2026"
                className="h-12 w-auto object-contain"
                loading="lazy"
                width="100"
                height="48"
          ...
          <div className="flex justify-center items-center gap-6 py-4">
            <div className="flex items-center justify-center">
              <img 
                ...
                alt="Filtered Quotes — Silver sponsor of Formula Forum 2026"
            ...
            <div className="flex items-center justify-center">
              <img 
                ...
                alt="Wintrust — Silver sponsor of Formula Forum 2026"
                className="h-10 w-auto object-contain"
                loading="lazy"
                width="80"
                height="40"
            ...
            <div className="flex items-center justify-center">
              <img 
                ...
                alt="Embrace Pet Insurance — Silver sponsor of Formula Forum 2026"
                className="h-10 w-auto object-contain"
                loading="lazy"
                width="80"
                height="40"
        ...
        <div>
          <h3 className="text-lg font-semibold text-center mb-4 text-foreground">
            Confirmed Formula³ Partners for 2026
          </h3>
