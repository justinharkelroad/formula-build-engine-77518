...
const SessionModal = ({ session, onClose }: SessionModalProps) => {
  ...
  return (
    <Dialog open={!!session} onOpenChange={(o) => !o && onClose()}>
      <DialogContent
        className="max-w-2xl border-white/20 text-white p-0 max-h-[88vh] overflow-y-auto"
      ...
      >
        ...
        <div className="p-7 md:p-10">
          ...
          {/* Title */}
          <h2 className="display-bold text-3xl md:text-5xl leading-[0.95] mb-8">{session.title}</h2>

          {/* The hook */}
          <div className="border-l-2 pl-5 md:pl-6 mb-8" style={{ borderColor: color }}>
          ...
          {/* Outcome */}
          <div className="border border-white/15 rounded-lg p-5 md:p-6 mb-6">
